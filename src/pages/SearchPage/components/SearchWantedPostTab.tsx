...
const SearchWantedPost = (props: SearchPostTabProps) => {
  ...
  React.useEffect(() => {
    queryClient.invalidateQueries({ queryKey: ['search', 'posts', 'wanted'] });
...
export default SearchWantedPost;
