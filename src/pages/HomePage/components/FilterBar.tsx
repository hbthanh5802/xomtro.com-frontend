...
const FilterBar = (props: FilterBarProps) => {
  ...
  return (
    <div className='tw-relative tw-rounded tw-bg-white tw-shadow'>
      <header className='tw-sticky tw-top-0 tw-z-10 tw-p-[8px] tw-flex tw-justify-between tw-bg-primaryColor'>
        <Typography
