  ...
  return (
    <>
      <ModalLayout maxWidth={'100%'} isOpen={openModal} onCloseModal={handleCloseModal}>
        <section className='PostCard__preview tw-rounded tw-overflow-y-auto tw-tracking-tighter tw-scroll-ml-4 !tw-scrollbar-thumb-slate-400 tw-max-h-[90dvh] tw-max-w-[90vw] tablet:tw-max-w-[680px] laptop:tw-max-w-[800px] tw-m-[-8px]'>
          {fullPostFetching ? (
            <PostCardSkeleton />
          ) : (
